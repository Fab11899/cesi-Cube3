...
test('returns a successful response api/product/2', function () {
    $response = $this->get('api/product/2');

    $response->assertStatus(200);
});

test('returns a successful response api/product/3', function () {
    $response = $this->get('api/product/3');

    $response->assertStatus(200);
});

test('returns a successful response api/product/4', function () {
    $response = $this->get('api/product/4');
